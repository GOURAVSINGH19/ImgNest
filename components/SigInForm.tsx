                ...
                <Card className="w-full rounded-xl overflow-hidden">
                    ...
                    <CardBody className="p-6">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div>
                                <label htmlFor="identifier" className="block text-sm font-medium text-default-900 mb-1">
                                    Email
                                </label>
                                <Input
                                    id="identifier"
                            ...
                            <div>
                                <label htmlFor="password" className="block text-sm font-medium text-default-900 mb-1">
                                    Password
                                </label>
                                <Input
                                    id="password"
